...
_MODEL_DEFAULTS = {
    ...
    # Tiered: cheap/fast mini for routing + tool-calling workers, standard gpt-5.4 for
    # the quality-critical synthesis/plan/content. Override any via SEO_*_MODEL.
    "openai": {"router": "openai/gpt-5.4-mini", "worker": "openai/gpt-5.4-mini",
               "synth": "openai/gpt-5.4"},
}
...
WRITE_TOOL_NAMES = {"publish_change", "apply_seo_changes", "generate_sitemap",
                    "write_robots", "create_page", "commit_changes", "push_changes",
                    "replace_in_repo"}
